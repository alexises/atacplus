...
BOOST_AUTO_TEST_CASE( small_decode_encode )
{
    ...
    unsigned char* encoded2 = encodeTacacsPacket(datachunk2, 32, "test",
		                        1, 1, TACACS_MAJOR + TACACS_MINOR_ONE);
    unsigned char* decoded1 = encodeTacacsPacket(datachunk1, 16, "test",
		                        1, 1, TACACS_MAJOR + TACACS_MINOR_ONE);
    unsigned char* decoded2 = encodeTacacsPacket(datachunk2, 32, "test",
		                        1, 1, TACACS_MAJOR + TACACS_MINOR_ONE);
...
BOOST_AUTO_TEST_CASE( check_unfinished_chunk )
{
    unsigned char* encoded2 = encodeTacacsPacket(datachunk2, 24, "test",
                                        1, 1, TACACS_MAJOR + TACACS_MINOR_ONE);
    unsigned char* decoded2 = encodeTacacsPacket(datachunk2, 24, "test",
                                        1, 1, TACACS_MAJOR + TACACS_MINOR_ONE);
...
BOOST_AUTO_TEST_CASE( check_multiple_decoding_fail )
{
    unsigned char* encoded2 = encodeTacacsPacket(datachunk2, 32, "test",
                                        1, 1, TACACS_MAJOR + TACACS_MINOR_ONE);
    unsigned char* decoded1 = encodeTacacsPacket(datachunk2, 32, "notest",
                                        1, 1, TACACS_MAJOR + TACACS_MINOR_ONE);
    unsigned char* decoded2 = encodeTacacsPacket(datachunk2, 32, "test",
                                        1, 1, TACACS_MAJOR + TACACS_MINOR_DEFAULT);
    unsigned char* decoded3 = encodeTacacsPacket(datachunk2, 32, "test",
                                        2, 1, TACACS_MAJOR + TACACS_MINOR_ONE);
    unsigned char* decoded4 = encodeTacacsPacket(datachunk2, 32, "test",
